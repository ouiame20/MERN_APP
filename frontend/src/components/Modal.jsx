...
//   onActionClick,
// }) => {
//   return <div className='fixed inset-0 z-50 justify-center items-center w-full h-full bg-black/40'>
//        {/* Modal Content */}
//   <div
...
const Modal = ({
  ...
  if (!isOpen) return null; // Optional: don't render if modal is closed
